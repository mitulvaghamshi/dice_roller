...
interface class Palette {
  ...
  Color get backgroundButton => const Color(0xFFFFB98E);
  ColorPair get backgroundMainSet =>
      (light: const Color(0xffffffd1), dark: const Color(0xffffffd1));
...
typedef ColorPair = ({Color light, Color dark});
